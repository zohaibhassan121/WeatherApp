...
const Weather = () => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=216ae54bafcdf9c0bc96a98328907424`
...

                        {
                            loader ?
                                ...
                                <div className='p-10'>
                                    ...
                                    {data.main ? <h1 className='text-4xl text-yellow-50 mt-2 mb-2'>{data.main.temp} &#8457;</h1> : null}
